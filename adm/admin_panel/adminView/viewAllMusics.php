<div>
    ...
    <button type="button" class="btn btn-secondary " style="height:40px;margin:6px 0" data-toggle="modal" data-target="#myModal">
        Add musics
    </button>
    <table class="table table-bordered ">
        ...
        ?>
                <tr>
                    ...
                    <td><button class="btn btn-primary" style="height:40px" onclick="oldDataMusic('<?= $row['m_id'] ?>')" data-toggle="modal" data-target="#my_Modal_edit">Edit</button></td>
                    <!-- Modal -->
                                ...
                                <div class="modal-body">
                                    <form enctype='multipart/form-data' method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Nhập tên bài hát" class="form-control" id="m_edit_name">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Artist Name:</label>
                                            <input type="text" placeholder="Nhập tên người thể hiện" class="form-control" id="m_edit_a_name">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Thời gian:</label>
                                            <input type="text" placeholder="Nhập thời lượng bài hát theo định dạng (00:00)" class="form-control" id="m_edit_time">
                                        </div>


                                        <div class="form-group">
                                            <label for="fileUploadIcon">Icon: </label>
                                            <input type="file" name="fileUploadIcon" id="m_edit_fileUploadIcon" class="form-control-file">
                                        </div>

                                        <div class=" form-group">
                                            <label for="fileUploadMusic">Liên kết: </label>
                                            <input type="file" name="fileUploadMusic" id="m_edit_fileUploadMusic" class="form-control-file">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-secondary" id="upload" style="height:40px" onclick="updateItems()">Update</button>
                                        </div>
                                    </form>
                                </div>
